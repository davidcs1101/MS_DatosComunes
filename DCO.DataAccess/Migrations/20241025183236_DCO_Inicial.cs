    ...
    public partial class DCO_Inicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "CAUSAEXTERNAANEXO2", true, new DateTime(2024, 10, 25, 13, 32, 35, 823, DateTimeKind.Local).AddTicks(3521), null, "CAUSAS EXTERNAS DE CONSULTA PARA ANEXO 2", 1, null },
                    { 2, "TIPOIDENTIANEXO", true, new DateTime(2024, 10, 25, 13, 32, 35, 823, DateTimeKind.Local).AddTicks(3523), null, "TIPOS DE IDENTIFICACIÓN PARA REGISTRO DE ANEXOS TÉCNICOS A PACIENTES", 1, null },
                    { 3, "TIPOIDENTIEMPRESA", true, new DateTime(2024, 10, 25, 13, 32, 35, 823, DateTimeKind.Local).AddTicks(3525), null, "TIPOS DE IDENTIFICACION PARA REGISTRO DE EMPRESAS", 1, null },
                    { 4, "TIPOIDENTIREGISTROUSUARIO", true, new DateTime(2024, 10, 25, 13, 32, 35, 823, DateTimeKind.Local).AddTicks(3526), null, "TIPOS DE IDENTIFICACIÓN PARA REGISTRO DE USUARIOS DE APLICACIÓN", 1, null },
                    { 5, "TIPOREGIMENANEXO2", true, new DateTime(2024, 10, 25, 13, 32, 35, 823, DateTimeKind.Local).AddTicks(3527), null, "TIPOS DE REGIMEN DISPONIBLES PARA ANEXO 2", 1, null },
                    { 6, "TIPOREGIMENANEXO3", true, new DateTime(2024, 10, 25, 13, 32, 35, 823, DateTimeKind.Local).AddTicks(3529), null, "TIPOS DE REGIMEN DISPONIBLES PARA ANEXO 3", 1, null },
                    { 7, "TIPOREGIMENANEXO9", true, new DateTime(2024, 10, 25, 13, 32, 35, 823, DateTimeKind.Local).AddTicks(3530), null, "TIPOS DE REGIMEN DISPONIBLES PARA ANEXO 9", 1, null },
                    { 8, "TRIAGEANEXO2", true, new DateTime(2024, 10, 25, 13, 32, 35, 823, DateTimeKind.Local).AddTicks(3531), null, "NIVELES DE TRIAGE PARA EL ANEXO 2", 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "CARGOSEMPLEADOS", true, new DateTime(2024, 10, 25, 13, 32, 35, 823, DateTimeKind.Local).AddTicks(3387), null, "CARGOS PARA EMPLEADOS", 1, null },
                    { 2, "CAUSASEXTERNAS", true, new DateTime(2024, 10, 25, 13, 32, 35, 823, DateTimeKind.Local).AddTicks(3404), null, "CAUSAS EXTERNAS SALUD", 1, null },
                    { 3, "ESPECIALIDAD", true, new DateTime(2024, 10, 25, 13, 32, 35, 823, DateTimeKind.Local).AddTicks(3406), null, "ESPECIALIDADES", 1, null },
                    { 4, "NIVELESCOMPLEJIDAD", true, new DateTime(2024, 10, 25, 13, 32, 35, 823, DateTimeKind.Local).AddTicks(3407), null, "NIVELES DE COMPLEJIDAD EN SALUD", 1, null },
                    { 5, "ESTADOANEXOS", true, new DateTime(2024, 10, 25, 13, 32, 35, 823, DateTimeKind.Local).AddTicks(3409), null, "ESTADOS DE LOS ANEXOS TÉCNICOS", 1, null },
                    { 6, "SERVICIOS", true, new DateTime(2024, 10, 25, 13, 32, 35, 823, DateTimeKind.Local).AddTicks(3410), null, "SERVICIOS DE SALUD", 1, null },
                    { 7, "SEXOBIOLOGICO", true, new DateTime(2024, 10, 25, 13, 32, 35, 823, DateTimeKind.Local).AddTicks(3412), null, "SEXO BIOLÓGICO", 1, null },
                    { 8, "TIPOAFILIACION", true, new DateTime(2024, 10, 25, 13, 32, 35, 823, DateTimeKind.Local).AddTicks(3413), null, "TIPOS DE AFILIACIÓN EN SALUD", 1, null },
                    { 9, "TIPOSIDENTIFICACION", true, new DateTime(2024, 10, 25, 13, 32, 35, 823, DateTimeKind.Local).AddTicks(3414), null, "TIPOS DE IDENTIFICACIÓN", 1, null },
                    { 10, "TIPOREGIMEN", true, new DateTime(2024, 10, 25, 13, 32, 35, 823, DateTimeKind.Local).AddTicks(3416), null, "TIPOS DE REGIMEN EN SALUD", 1, null },
                    { 11, "TIPOSTRIAGE", true, new DateTime(2024, 10, 25, 13, 32, 35, 823, DateTimeKind.Local).AddTicks(3417), null, "TIPOS DE TRIAGE", 1, null }
                });
            ...
            INSERT INTO DCO_DatosConstantesDetalles (DatoConstanteId,DatoId,EstadoActivo,UsuarioCreadorId,FechaCreado)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DCO_DatosConstantesDetalles_DatoConstanteId_DatoId",
                table: "DCO_DatosConstantesDetalles",
                columns: new[] { "DatoConstanteId", "DatoId" },
                unique: true);
